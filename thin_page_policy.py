...
_THIN_AI_RE = _re.compile(
    ...
    r"判断(でき|し)(ません|づらい|かねます)|判断(が|材料が)(難し|限定的|少な|不足)|判定不可)"
)
# 2026-07-13 「判断材料が不足」の表記ゆれを追加（整合性監査の未決①・ユーザー承認済み。
# 影響：has_substantive_ai変化5院・うちis_thin反転は久留島歯科医院1院のみと事前定量確認）
